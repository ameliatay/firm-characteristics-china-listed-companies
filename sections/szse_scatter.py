...
def filters():
    ...
    with ownership_selected.container():
        ...
        selected_owership = st.multiselect("Select Ownership Type", options=ownership_list, key="ownership_shenzhen", help=f"Select the ownership type you wish to view")
